...
const lightPrimaryColorCode = 0xFFA9DFD8;
...
const lightContainerColor = Color(0xFFF0F0F3);
const darkContainerColor = Color(0xFF2A2D3E);

const String Dashboard = "Dashboard";
const String Manage_Video = "Manage Video";
